const C = 'lull-v27';
const ASSETS = ['/', '/app', '/privacy', '/assets/lull.js', '/assets/orb-glass.webp', '/assets/orb-swirl-b.webp', '/assets/orb-swirl-c.webp', '/assets/orb-swirl-d.webp', '/assets/orb-thumb-solstice.png', '/assets/orb-thumb-frost.png', '/assets/orb-thumb-nova.png', '/assets/orb-thumb-ion.png', '/manifest.webmanifest', '/icon-192.png', '/icon-512.png', '/apple-touch-icon.png', '/favicon-32.png'];
